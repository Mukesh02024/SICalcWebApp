namespace SICalcWebApp.Areas.RiceMill.Models
{
    public class BatchProcessReport
    {
        ...
        // Dryer Process
        public double DryerHandiTimeDifference { get; set; }  // This will be mapped from SQL
        public DateTime DryerLoadTime { get; set; }
        public DateTime DryerUnloadTime { get; set; }
        public double DuctiPressure { get; set; }
        public string DryerUnloadBunk { get; set; }
        public string DryerStaff { get; set; }

        public double? DryerDelay { get; set; }
        public double DryerTakenTime { get; set; }
